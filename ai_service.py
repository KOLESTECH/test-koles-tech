...
# ========== PROMPT TEMPLATES (без праздничных мотивов) ==========
...
class AdvancedAISessionManager:
    ...
    def force_rotate_key(self):
        ...
        if self.gemini_api_keys:
            ...
            logger.info(f"Принудительная ротация: новый индекс {self.current_key_index}")
